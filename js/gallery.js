...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const baseDeDatosFotos = [
        ...
        "img/cap/capping-curso.jpg", "img/cap/capping-hero-1.webp", "img/cap/capping-hero-2.webp",
    ...
    function crearCuadroFoto(rutaFoto) {
        ...
        div.innerHTML = `
            <img src="${rutaFoto}" alt="Trabajo Santas Uñas" class="gallery__img" loading="lazy">
    ...
    document.addEventListener('visibilitychange', () => {
        if (document.hidden) {
            ...
            // Limpiamos el intervalo para dejar de consumir recursos.
            clearInterval(rotacionAutomatica);
        } else {
            // El usuario volvió a nuestra pestaña.
            // Solo reanudamos la rotación si la galería completa NO está abierta.
            if (!estadoGaleriaCompleta) {
                arrancarRotacion();
            }
        }
